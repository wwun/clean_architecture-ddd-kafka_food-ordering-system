...
public class PaymentDomainServiceImpl implements PaymentDomainService {
    ...
    //como validar y procesar pagos, cancelar pagos, actualizar el historial de crédito, etc, pertenece al core, donde se encuentran los casos de uso de la aplicación
